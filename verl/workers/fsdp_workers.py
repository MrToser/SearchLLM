...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if not torch.distributed.is_initialized():
            print("init distributed process group at ActorRolloutRefWorker")
    ...
    def _build_model_optimizer(self,
        ...
        if self._is_actor:
            ...
            assert warmup_direction in {'up', 'down', 'cos', 'parabola', 'down_constant', 'parabola_down_constant'}, \
    ...
    def generate_sequences(self, prompts: DataProto):
        # print("---------[Debug]--------- in ActorRolloutRefWorker generate_sequences ")
