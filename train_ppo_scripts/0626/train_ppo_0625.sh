...
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-3b-it-em-amd-0625
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.entropy_coeff_mode="up_down" \
    +actor_rollout_ref.actor.raw_entropy_coeff=0.001 \
    +actor_rollout_ref.actor.entropy_coeff_warmup_steps_ratio=0.25 \
    \
    do_search=True \
