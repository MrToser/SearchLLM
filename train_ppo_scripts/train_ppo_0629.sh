...
export DATA_DIR='data/ids_augument_filter_2_divide_easy_medium_hard'
...
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-3b-it-em-amd-0629
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    searchllm.mode="base" \
    \
    data.train_files=$DATA_DIR/train_easy_medium_hard.parquet \
